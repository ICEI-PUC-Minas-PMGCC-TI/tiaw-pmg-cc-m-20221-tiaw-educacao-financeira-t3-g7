...
function getInfoBasedOnScore(){
    if(totalScore() < 15){
        var score_info = "Tome cuidado, você deveria procurar se informar mais sobre educação financeira";
    } else if(totalScore() > 15){
        var score_info = "Parabéns! Você parece ter um bom perfil financeiro"
    }
